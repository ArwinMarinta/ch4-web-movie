    ...
    <div className="relative">
      ...
      <div className="absolute top-4 bottom-4 left-8  flex items-center">
        <div className="flex flex-col justify-center gap-10 lg:pl-56 ">
          ...
          <div className="md::text-2xl text-red-600 w-[50%] md:font-semibold ">
            {detailMovie?.overview}
          </div>
          <div className="md:text-lg text-red-600">
            {detailMovie?.vote_average}
          </div>
          <Link
            className="flex md:px-6 md:py-3 px-2 py-2 w-max bg-red-600 md:text-3xl text-white md:rounded-2xl rounded-xl"
            as={Link}
